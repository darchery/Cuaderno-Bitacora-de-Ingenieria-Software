public class Main {
    public static void main(String[] args) {
        ...
        LavadoraNormal lavadoraNormal = new LavadoraNormal("BOSCH", 100, 60,
                1000, 8, 50);
        LavadoraSecadora lavadoraSecadora = new LavadoraSecadora("LG", 120, 80,
                1200, 10, 80);
        ...
        // Se limpia la ropa
        estadoColada1Jersey1.setEstado(EstadoPrenda.LIMPIO);
        estadoColada1Camiseta1.setEstado(EstadoPrenda.LIMPIO);
        // Se acaba la colada
        coladaNormal.setFin(10);
        ...
        // Se limpia la ropa
        estadoColada1Jersey2.setEstado(EstadoPrenda.LIMPIO);
        estadoColada1Camiseta2.setEstado(EstadoPrenda.LIMPIO);
        // Se acaba la colada
        coladaSecado.setFin(12);
        System.out.println("    - La ropa se ha limpiado y la colada ha terminado");
        System.out.println("    - ¿Está en funcionamiento?:" + lavadoraSecadora.enFuncionamiento());
